...
const chai = require('chai'),
      ...
      State = require('./state'),
      MyState = require('../test/mocks/my_state');
  ...
  describe('#constructor', () => {
    ...
    describe('when extended', () => {
      ...
      describe('with valid parameters', () => {
        ...
        it('stores `config.values` as an instance property', () => {
          chai.expect(state.values).to.equal(config.values);
        });
        ...
        it('creates an instance of StateMachine with the correct parameters', () => {
          ...
          chai.expect(state.state).to.equal(statemachineInstance);
        });
